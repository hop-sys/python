...
#modulus - is the remainder of a number when it gets subdivided with another one
number10 = 5
number9 = 14
modulus = number9 % number10
print("The modulus of the numbers is: ", modulus)

#Floor division - This is the number of times a number subdivides another one ignoring the remainder
